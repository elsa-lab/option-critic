...
COMMON_SPEC_TEMPLATE_PATH_TO_READ = '../../.templates/common.template.yml'
...
def read_common_template():
    return read_template(COMMON_SPEC_TEMPLATE_PATH_TO_READ)
...
def write_specs(
        spec_template, common_template, run_template, download_template):
    # Write all specs
...
def build_common_content(common_template, format_mapping):
    ...
    return common_template.format_map(format_mapping)
...
def main():
    ...
    # Write the specs
    write_specs(spec_template, common_template,
